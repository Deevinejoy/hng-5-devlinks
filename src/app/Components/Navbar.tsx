...
export default function Navbar() {
  ...
  return (
    <div className="navbar bg-[white] p-[16px] m-[24px]  flex  justify-between rounded-[12px]">
        ...
        <div className="flex gap-x-[px] md:gap-x-[8px]">
            <Link href='/Homepage'
            className={`flex pt-[11px] pb-[11px] pr-[27px] pl-[27px] gap-x-[8px] ${isClick ? 'text-red-500' : 'text-[#737373]'}`}
        ...
        <div className="flex gap-[30px]">
            <Link className={`flex pt-[11px] pb-[11px] pr-[27px] pl-[27px] gap-x-[8px] ${isClick ? 'text-red-500' : 'text-[#737373]'}`
            }
            onClick={togglenavbar}
            href="./Preview">
